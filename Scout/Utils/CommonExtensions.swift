...
//  Scout
//
//  Created by Stefan Olaru on 02/09/2017.
...
extension UIColor {
    convenience init(red: Int, green: Int, blue: Int) {
        ...
        self.init(red: CGFloat(red) / 255.0, green: CGFloat(green) / 255.0, blue: CGFloat(blue) / 255.0, alpha: 0.6)
    }
...
extension UIView {
    ...
    /// Used to start rotating the ball
    ...
    /// Used to stop rotating the ball 
    func stopRotating() {
        let kAnimationKey = "rotation"
        if self.layer.animation(forKey: kAnimationKey) != nil {
...
extension UINavigationBar {
    ...
    func transparentNavigationBar() {
        ...
        self.tintColor = UIColor.FlatColor.Green.PersianGreen
        self.titleTextAttributes = [NSAttributedStringKey.foregroundColor.rawValue: UIColor.FlatColor.Green.PersianGreen]
    }
